...
namespace Nomina {
    ...
    public partial class _payroll_unapecDataSet : global::System.Data.DataSet {
        ...
        public partial class TransactionsDataTable : global::System.Data.TypedTableBase<TransactionsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TransactionsRow AddTransactionsRow(System.DateTime Date, double Amount, string Status, EmployeesRow parentEmployeesRowByFK_TransactionEmployee) {
                ...
                if ((parentEmployeesRowByFK_TransactionEmployee != null)) {
                    columnValuesArray[4] = parentEmployeesRowByFK_TransactionEmployee[0];
                }
...
SELECT Id, Name, RiskLevel, MinSalary, MaxSalary FROM Positions WHERE (Id = @Id)";
    ...
    public partial class TransactionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Transactions] ([Date], [Amount], [Status], [Employee_Id]) VALU" +
                "ES (@Date, @Amount, @Status, @Employee_Id);\r\nSELECT Id, Date, Amount, Status, Em" +
                "ployee_Id FROM Transactions WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Transactions] SET [Date] = @Date, [Amount] = @Amount, [Status] = @Status, [Employee_Id] = @Employee_Id WHERE (([Id] = @Original_Id) AND ([Date] = @Original_Date) AND ([Amount] = @Original_Amount) AND ([Employee_Id] = @Original_Employee_Id));
SELECT Id, Date, Amount, Status, Employee_Id FROM Transactions WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Date, Amount, Status, Employee_Id FROM dbo.Transactions";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(System.DateTime Date, double Amount, string Status, int Employee_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime Date, double Amount, string Status, int Employee_Id, int Original_Id, System.DateTime Original_Date, double Original_Amount, int Original_Employee_Id, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime Date, double Amount, string Status, int Employee_Id, int Original_Id, System.DateTime Original_Date, double Original_Amount, int Original_Employee_Id) {
            return this.Update(Date, Amount, Status, Employee_Id, Original_Id, Original_Date, Original_Amount, Original_Employee_Id, Original_Id);
        }
    }
